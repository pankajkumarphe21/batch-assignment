...
const Footer = () => {
  return (
    <div className='flex flex-col mt-[180px] w-[100%] max-sm:mx-[5%] mx-[7%] items-center'>
      <div className="flex">
        ...
        <div className="flex flex-col links mt-[2px] ml-[40px] max-sm:ml-[9vw]">
        ...
        <div className="flex flex-col mt-[2px] ml-[40px] max-sm:ml-[9vw]">
