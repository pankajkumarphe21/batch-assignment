  ...
  return (
    <div>
      <div className="flex relative max-sm:flex-col max-sm:mx-[4vw]">
        ...
        <div className="absolute max-sm:top-[570px] max-sm:left-[164px]  top-[190px] left-[62vw] rounded-[50%] rotate-[58deg] transform -translate-x-1/2 -translate-y-1/2 w-[440px] h-[300px] border-[1px] border-black "></div>
        <div className="absolute max-sm:top-[570px] max-sm:left-[179px] top-[199px] left-[63vw] rounded-[50%] rotate-[58deg] transform -translate-x-1/2 -translate-y-1/2 w-[440px] h-[300px] border-[1px] border-black"></div>
        <div className="absolute max-sm:top-[570px] max-sm:left-[194px] top-[199px] left-[64vw] rounded-[50%] rotate-[58deg] transform -translate-x-1/2 -translate-y-1/2 w-[440px] h-[300px] border-[1px] border-black"></div>
        ...
        <div className="relative">
          <Image
            className="ml-[243px] max-sm:mt-[10px] max-sm:ml-[43px] mt-[-55px]"
